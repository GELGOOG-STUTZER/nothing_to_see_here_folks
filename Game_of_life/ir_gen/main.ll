...
define dso_local void @_Z11init_pixelsv() #2 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  br label %3
...
declare dso_local void @_Z11init_windowjj(i32, i32) #1

declare dso_local zeroext i1 @_Z14window_is_openv() #1

declare dso_local void @_Z12window_clearv() #1

declare dso_local void @_Z11check_eventv() #1

declare dso_local void @_Z5flushv() #1
